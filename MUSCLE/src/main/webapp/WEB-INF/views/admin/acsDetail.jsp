   ...
   <div class="container" style="width:65%">
      ...
      <div style="float:right;">
         ...
         <input type="hidden" name="NOTICE_NUM" id="NOTICE_NUM" value="${map.NOTICE_NUM}"/>
         	...
         	<a href="#this" id="modifyFaq"><button type="button" class="btn btn-outline-primary" style="margin-right:6px; background-color:white; color:hotpink; border-color:hotpink;">FAQ수정</button></a>
         	</c:if>
         	<c:if test="${map.NOTICE_TYPE != 'FAQ' }">
         	<a href="#this" id="modify"><button type="button" class="btn btn-outline-primary" style="margin-right:6px; background-color:hotpink; color:white; border-color:hotpink;">공지수정</button></a>
         	</c:if>
         ...
         <button type="button" class="btn btn-outline-primary" onclick="javascript:history.go(-1);" style="margin-right:6px; background-color:white; color:hotpink; border-color:hotpink;">목록</button>
         </c:if>
         <c:if test="${session_MEMBER.MEM_NICK != map.NOTICE_WRITER}">
