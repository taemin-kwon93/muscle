...
<div class="container" id="frm" style="width:60%;">
   ...
   <!-- 버튼 -->
   <div align="center">
        <a href="#this" id="modify"><input style="background-color:hotpink; border-color:hotpink; color:white;" type="button" class="btn btn-primary" value="공지 수정"></a>
      <input style="background-color:white; border-color:hotpink; color:hotpink;" type="button" class="btn btn-outline-primary" value="취소" onClick="javascript:history.go(-1)">
   </div>
</div>
</form>
