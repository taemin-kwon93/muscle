...
<div align="center">
   <h3><b>교환/반품/취소 처리</b></h3> 
</div>
<div style="height: 30px;"></div>
<div align="center" style="width:1000px; margin-left:auto; margin-right:auto;">
<ul class="nav nav-tabs">
     <li class="active">
       <a style=color:pink; class="nav-link" href="<c:url value='/admin/order_admin_a.do'/>">주문관리</a>
     </li>
     <li class="nav-item">
       <a style=color:hotpink; class="nav-link active" href="<c:url value='/admin/as_admin.do?as=4'/>">교환/반품/취소</a>
     </li>
</ul>
		...
		<nav>
			...
			<c:choose>
				<c:when test="${fn:length(as_admin_list) > 0}">
                  ...
                  |&nbsp;<li class="active"><a href="/muscle/admin/as_admin.do?as=4" style="text-decoration:none; color:hotpink;"><strong>취소 접수</strong></a> | </li>&nbsp;
                  </c:when>
                  <c:otherwise>
               ...
               <c:choose>
                  ...
                  <li class="active"><a href="/muscle/admin/as_admin.do?as=5" style="text-decoration:none; color:hotpink;">취소 완료</a> | </li>&nbsp;
                  </c:when>
                  <c:otherwise>
                  <li><a href="/muscle/admin/as_admin.do?as=5">취소 완료</a> | </li>&nbsp;
					...
					<c:choose>
						...
						<li class="active"><a href="/muscle/admin/as_admin.do?as=6" style="text-decoration:none; color:hotpink;"><strong>교환 접수 </strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
					...
					<c:choose>
						...
						<li class="active"><a href="/muscle/admin/as_admin.do?as=7" style="text-decoration:none; color:hotpink;"><strong>교환 중 </strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
					...
					<c:choose>
						...
						<li class="active"><a href="/muscle/admin/as_admin.do?as=8" style="text-decoration:none; color:hotpink;"><strong>교환 완료 </strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
				...
				<c:otherwise>
                  ...
                  |&nbsp;<li class="active"><a href="/muscle/admin/as_admin.do?as=4" style="text-decoration:none; color:hotpink;">취소 접수</a> | </li>&nbsp;
                  </c:when>
                  <c:otherwise>
                  |&nbsp;<li><a href="/muscle/admin/as_admin.do?as=4">취소 접수</a> | </li>&nbsp;
                  </c:otherwise>
               ...
               <c:choose>
                  ...
                  <li><a href="/muscle/admin/as_admin.do?as=5">취소 완료</a> | </li>&nbsp;
					...
					<c:choose>
						...
						<li class="active"><a href="/muscle/admin/as_admin.do?as=6" style="text-decoration:none; color:hotpink;">교환 접수</a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/muscle/admin/as_admin.do?as=6">교환 접수 </a> | </li>&nbsp;
						</c:otherwise>
					...
					<c:choose>
						...
						<li class="active"><a href="/muscle/admin/as_admin.do?as=7" style="text-decoration:none; color:hotpink;">교환 중</a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/muscle/admin/as_admin.do?as=7">교환 중 </a> | </li>&nbsp;
						</c:otherwise>
					...
					<c:choose>
						...
						<li class="active"><a href="/muscle/admin/as_admin.do?as=8" style="text-decoration:none; color:hotpink;">교환 완료</a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/muscle/admin/as_admin.do?as=8">교환 완료 </a> | </li>&nbsp;
						</c:otherwise>
					...
					<c:choose>
						...
						<li class="active"><a href="/muscle/admin/as_admin.do?as=9" style="text-decoration:none; color:hotpink;">반품 접수</a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/muscle/admin/as_admin.do?as=9">반품 접수 </a> | </li>&nbsp;
						</c:otherwise>
					...
					<c:choose>
						...
						<li class="active"><a href="/muscle/admin/as_admin.do?as=10" style="text-decoration:none; color:hotpink;">반품 완료</a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/muscle/admin/as_admin.do?as=10">반품 완료</a> | </li>&nbsp;
						</c:otherwise>
						...
						<tr class="list_title">
							...
							<c:choose>
								<c:when test="${aal.AORDER_STATE eq '4'}">
									<td><input type="button" onclick="as_ok(${aal.AORDER_NUM }, ${aal.AORDER_STATE }, ${aal.AORDER_ORDER_NUM })" value="요청확인"  class="btn btn-primary btn-sm" style="margin-bottom:2px; background-color:hotpink; border-color:hotpink; color:white;"/>
									<br /><input type="button" onclick="as_cancle(${aal.AORDER_NUM }, ${aal.AORDER_STATE }, ${aal.AORDER_ORDER_NUM })" value="요청취소" class="btn btn-outline-primary btn-sm"  style="background-color:white; border-color:hotpink; color:hotpink;" /></td>
								</c:when>
								...
								<c:when test="${aal.AORDER_STATE eq '6'}">
									<td><input type="button" onclick="as_ok(${aal.AORDER_NUM }, ${aal.AORDER_STATE }, ${aal.AORDER_ORDER_NUM })" value="요청확인"  class="btn btn-primary btn-sm" style="margin-bottom:2px background-color:hotpink; border-color:hotpink; color:white;"/>
									<br /><input type="button" onclick="as_cancle(${aal.AORDER_NUM }, ${aal.AORDER_STATE }, ${aal.AORDER_ORDER_NUM })" value="요청취소" class="btn btn-outline-primary btn-sm" style="margin-bottom:2px; background-color:white; border-color:hotpink; color:hotpink;" /></td>
								</c:when>
								<c:when test="${aal.AORDER_STATE eq '7' }">
									<td><input type="button" onclick="as_ok(${aal.AORDER_NUM }, ${aal.AORDER_STATE }, ${aal.AORDER_ORDER_NUM })" value="교환완료" class="btn btn-primary btn-sm" style="margin-bottom:2px; background-color:hotpink; border-color:hotpink; color:white"/>
									<br /><input type="button" onclick="as_cancle(${aal.AORDER_NUM }, ${aal.AORDER_STATE }, ${aal.AORDER_ORDER_NUM })" value="요청취소" class="btn btn-outline-primary btn-sm" style="background-color:white; border-color:hotpink; color:hotpink;"/></td>
								</c:when>
