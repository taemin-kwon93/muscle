...
<div class="container" id="frm" style="width:60%;">
   ...
   <!-- 버튼 -->
   <div align="center">
        <a href="#this" id="write"><input type="button" class="btn btn-primary" style="background-color:hotpink; color:white; border-color:hotpink;" value="등록"></a>
      <input style="background-color:white; border-color:hotpink; color:hotpink;" type="button" class="btn btn-outline-primary"  value="취 소"  onclick="location.href='/muscle/admin/faqBoardList.do'">
   </div>
</div>
</form>
<!-- footer       -->
